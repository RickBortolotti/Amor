...
const startDate = new Date('2022-06-12'); // Substitua pela data do seu relacionamento
...
function updateCountdown() {
    ...
    if (displayYears > 0) {
        countdownElement.textContent = `${displayYears} ano(s), ${displayMonths} mês(es) e ${days} dia(s) juntos!`;
    } else {
        countdownElement.textContent = `${displayMonths} mês(es) e ${days} dia(s) juntos!`;
    }
}
